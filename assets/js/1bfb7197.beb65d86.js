...
/* @jsxRuntime classic */ /* @jsx mdx */ /* @jsxFrag React.Fragment */const frontMatter={};const contentTitle='사용법';const metadata={"unversionedId":"usage/index","id":"usage/index","title":"사용법","description":"","source":"@site/docs/usage/index.mdx","sourceDirName":"usage","slug":"/usage/","permalink":"/docs/usage/","draft":false,"editUrl":"https://github.com/MC-Dashify/document/edit/main/docs/usage/index.mdx","tags":[],"version":"current","frontMatter":{},"sidebar":"tutorialSidebar","previous":{"title":"Dashify란?","permalink":"/docs/intro"},"next":{"title":"Dashify Launcher 시작하기","permalink":"/docs/usage/launcher/getting-started"}};const assets={};const toc=[];const layoutProps={toc};const MDXLayout="wrapper";function MDXContent(_ref){let{components,...props}=_ref;return (0,esm/* mdx */.kt)(MDXLayout,(0,esm_extends/* default */.Z)({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),(0,esm/* mdx */.kt)("h1",{"id":"사용법"},`사용법`),(0,esm/* mdx */.kt)(DocCardList,{mdxType:"DocCardList"}));};MDXContent.isMDXComponent=true;
