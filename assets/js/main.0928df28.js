...
/* harmony default export */ const routes = ([{path:'/downloads/client',component:ComponentCreator('/downloads/client','a3f'),exact:true},{path:'/downloads/launcher',component:ComponentCreator('/downloads/launcher','4f6'),exact:true},{path:'/docs',component:ComponentCreator('/docs','470'),routes:[{path:'/docs/intro',component:ComponentCreator('/docs/intro','aed'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/usage/',component:ComponentCreator('/docs/usage/','6c4'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/usage/client/getting-started',component:ComponentCreator('/docs/usage/client/getting-started','81e'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/usage/client/server-profiles',component:ComponentCreator('/docs/usage/client/server-profiles','690'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/usage/launcher/advanced',component:ComponentCreator('/docs/usage/launcher/advanced','ac6'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/usage/launcher/getting-started',component:ComponentCreator('/docs/usage/launcher/getting-started','ca9'),exact:true,sidebar:"tutorialSidebar"},{path:'/docs/usage/launcher/server-configuration',component:ComponentCreator('/docs/usage/launcher/server-configuration','507'),exact:true,sidebar:"tutorialSidebar"}]},{path:'/',component:ComponentCreator('/','833'),exact:true},{path:'*',component:ComponentCreator('*')}]);
...
const globalData_namespaceObject = JSON.parse('{"docusaurus-plugin-content-docs":{"default":{"path":"/docs","versions":[{"name":"current","label":"Next","isLast":true,"path":"/docs","mainDocId":"intro","docs":[{"id":"intro","path":"/docs/intro","sidebar":"tutorialSidebar"},{"id":"usage/client/getting-started","path":"/docs/usage/client/getting-started","sidebar":"tutorialSidebar"},{"id":"usage/client/server-profiles","path":"/docs/usage/client/server-profiles","sidebar":"tutorialSidebar"},{"id":"usage/index","path":"/docs/usage/","sidebar":"tutorialSidebar"},{"id":"usage/launcher/advanced","path":"/docs/usage/launcher/advanced","sidebar":"tutorialSidebar"},{"id":"usage/launcher/getting-started","path":"/docs/usage/launcher/getting-started","sidebar":"tutorialSidebar"},{"id":"usage/launcher/server-configuration","path":"/docs/usage/launcher/server-configuration","sidebar":"tutorialSidebar"}],"draftIds":[],"sidebars":{"tutorialSidebar":{"link":{"path":"/docs/intro","label":"intro"}}}}],"breadcrumbs":true}}}');
